...
file_path = 'https://github.com/JamiEmersonUTS/selenium-github-actions/blob/main/CV_Jane_Smith.docx'
...
try:
    ...
    choose_file = driver.find_element(By.ID, "file_up").send_keys('selenium-github-actions/CV_Jane_Smith.docx')
